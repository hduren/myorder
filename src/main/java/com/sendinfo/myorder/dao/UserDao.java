...
public class UserDao extends SqlMapClientDaoSupport {
	public int addUser(User user) {
		...
		Student student = (Student) getSqlMapClientTemplate().queryForObject(
				"queryStudentById", "ph");
		System.out.println(student.getName());

		Object obj = getSqlMapClientTemplate().insert("insertUserGroup",
				userGroup);
		Object userobj = getSqlMapClientTemplate().insert("adduser",
				user);
